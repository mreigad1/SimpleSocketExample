...
COMPILATION_FLAGS=-O2 -Wall -Wextra -std=c99 -pedantic -Wmissing-prototypes -Wstrict-prototypes -Wold-style-definition -Wincompatible-pointer-types -Wno-missing-field-initializers -Wno-unused-result
